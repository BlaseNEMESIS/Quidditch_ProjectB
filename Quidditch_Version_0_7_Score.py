...
class Scoreboard(pygame.sprite.Sprite):
    ...
    def update(self):
        self.text = "Health: %s, Gryfindor Score: %d, Hufflepuff Score: %d" % (self.health, self.score, self.enemyScore)
...
def game():
    pygame.display.set_caption("Quidditch - Gryfindor V.S. HufflePuff")
    ...
    enemySprites = pygame.sprite.Group(enemyFlier1, enemyFlier2, enemyFlier3, enemyFlier4, enemyFlier5)
